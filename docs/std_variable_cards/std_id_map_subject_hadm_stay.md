# Public Variable Card: std_id_map_subject_hadm_stay
...
- `std_variable_id`: `std_id_map_subject_hadm_stay`
- standardized Chinese name: `患者-住院-ICU映射`
- standardized English name: `subject-hadm-stay mapping`
...
Standardized subject-hadm-stay mapping. Value type: id_mapping. Grain: ICU stay.
