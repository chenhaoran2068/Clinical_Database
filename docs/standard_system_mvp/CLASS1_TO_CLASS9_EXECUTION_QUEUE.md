...
| std_advanced_respiratory_support_active | class3_binary_state_episode | owner_approved_restricted_partial | Amsterdam governed build exists from approved IMV and NIV parents, but the public same-name concept includes HFNC and no narrow Amsterdam HFNC source is approved in the current source surface. | approved on 2026-05-29 only as restricted partial IMV/NIV evidence with explicit HFNC gap |
